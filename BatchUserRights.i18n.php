...
$messages['ko'] = array(
	...
	'batchuserrights-desc' => '작업 하나의 더 많은 그룹이나 그룹에 하나 이상의 사용자를 추가하는 것을 허용',
...
문서의 나머지 부분은 사용자 이름 중 하나를 불러올 수 없으면 쉽게 볼 수 있게 실행하도록 허용합니다.',
	'right-batchuserrights' => '작업 하나의 더 많은 그룹이나 그룹에 하나 이상의 사용자를 추가함',
);
...
З міркувань безпек список доступних груп встановлений у налаштуваннях розширення і не може бути змінений у вікі.
...
Решту сторінки буде оброблено, щоб показати користувачів, яких не можна завантажити.',
	'right-batchuserrights' => 'Додавання одного чи кількох користувачів до однієї і більше груп за одну дію',
);
